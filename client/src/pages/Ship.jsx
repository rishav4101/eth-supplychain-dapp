...
const Ship = () => {
  ...
  const handleShipButton = async (prod) => {
    switch (hasRole) {
      case Roles.Manufacture:
        await contract.methods
          .shipToThirdParty(prod[0][0])
          .send({ from: accounts[0] })
